...
public class Stopwordscombiner extends Configured implements Tool {
   
	public static void main(String[] args) throws Exception {
      System.out.println(Arrays.toString(args));
      int res = ToolRunner.run(new Configuration(), new Stopwordscombiner(), args);
   ...
   public int run(String[] args) throws Exception {
	...
	Job job = new Job(getConf(), "Stopwordscombiner");
